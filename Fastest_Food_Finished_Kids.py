# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 21:29:18 2022
...
def getJobs(attrs):
    ...
    for key, value in attrs.items():
        jobs.append([[(value['prep']//5,0),(value['prep']//5,1)],[(value['cook']//5,2),(value['cook']//5,3)], value['kid']])
    return jobs
...
class SolutionPrinter(cp_model.CpSolverSolutionCallback):
    ...
    def on_solution_callback(self):
        ...
        #     print('Stop search after %i solutions' % 20)
        #     self.StopSearch()
    ...
    for job_id in all_jobs:
        ...
        for task_id in range(num_tasks):
            ...
            if jobs[job_id][2]==True:
                ...
                Wi=100000
                #Wi=model.NewIntVar(1, 1, '')
            else:
                Wi=0
                #Wi=model.NewConstant(0)
                #Wi=model.NewIntVar(0,0,'')
            weights.append(Wi)
